<script lang="ts">
	...
	export let canRequestControl = false;
	export let isControlling = false;
	export let onRequestControl: () => void = () => {};
	export let onStopControl: () => void = () => {};
</script>
...
<div class="bar">
	...
	<div class="right-group">
		...
		{#if canRequestControl || isControlling}
			<button
				class="side-btn"
				class:active={isControlling}
				on:click={isControlling ? onStopControl : onRequestControl}
				title={isControlling ? 'Stop controlling' : 'Request control'}
				aria-label={isControlling ? 'Stop controlling' : 'Request control'}
			>
