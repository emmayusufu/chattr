...
export function findLargestVideo(): HTMLVideoElement | null {
...
export async function askGemini({
	...
	const prompt = context
		? `${context}\n\nQuestion: ${question}\n\nReply concisely (1-4 sentences). If you see an error or stack trace in the image, quote the key line.`
		: `${question}\n\nReply concisely (1-4 sentences). If you see an error or stack trace in the image, quote the key line.`;
